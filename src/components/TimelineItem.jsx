...
function TimelineItem({ year, title, duration, details }) {
   return (
      <ol className="flex flex-col md:flex-row relative border-l ml-5 border-stone-200 dark:border-stone-700">
         <li className="mb-10 ml-4">
            ...
            <p className="flex flex-wrap gap-4 flex-row items-center justify-start text-xs md:text-sm">
               ...
               <h3 className="text-lg font-semibold text-stone-400  dark:text-white">
                  {title}
               </h3>
